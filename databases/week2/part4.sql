...
create table
    book(
        ...
        CONSTRAINT rating FOREIGN KEY (rating_id) REFERENCES rating(id),
        CONSTRAINT publish FOREIGN KEY (publisher_id) REFERENCES publisher(id)
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
create table
    user(
        ...
        favourite_book_id int(10) unsigned,
        favourite_author_id int(10) unsigned,
        PRIMARY KEY (id),
        CONSTRAINT book FOREIGN KEY (favourite_book_id) REFERENCES book(id),
        CONSTRAINT fav_author FOREIGN KEY (favourite_author_id) REFERENCES author(id)
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
